...
describe("Employee Manager 1.2", () => {
    ...
    describe("handles unsaved, canceled, and saved changes correctly", () => {
        ...
        */
        ...
        /* This is me doing my homework and testing this out.
        I'm hoping this works so I don't need to ask more questions.
        Here goes nothing.
        */
        ...
        test("A canceled change doesn't persist", async () => {
            ...
            */
            ...
            await driver.findElement(nameInput).clear();
            //I am beginning to understand and make more educated decisions for syntax
            await driver.findElement(nameInput).sendKeys("Test Name");
